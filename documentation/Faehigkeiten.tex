...
Die Perceptor und Effector names sind in der folgenden \href{http://simspark.sourceforge.net/wiki/index.php/Models}{Tabelle} \cite{Models} aufgeführt.
...
Aufstehbewegungen (vom Bauch und vom Rücken) der \href{http://www.naoteamhumboldt.de/de/}{Humboldt Universität}\cite{HU}
...
vollständig gerade wieder hin. Dieser Keyframe wurde von der \href{http://www.naoteamhumboldt.de/de/}{Humboldt Universität}\cite{HU} benutzt und musste nur an einigen Stellen verändert werden.

\subparagraph{Aufstehen vom Bauch aus}
Hier hatten wir einen Keyframe von der \href{http://www.naoteamhumboldt.de/de/}{Humboldt Universität}\cite{HU} zur Verfügung, der unseren NAO jedoch nicht aufstehen lassen hat. Deshalb wurde er entwickelt. ...
